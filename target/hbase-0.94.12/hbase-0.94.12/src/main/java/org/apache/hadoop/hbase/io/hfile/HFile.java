...
public class HFile {
  ...
  private static Reader pickReaderVersion(Path path, FSDataInputStream fsdis,
    ...
    LOG.info("The Hfile Path is :"+fullPathStr); 
    if(fullPathStr.startsWith(parentPathStr)){throw new IllegalArgumentException("Corrupt file is making its way to regions!");} 
    } catch (IllegalArgumentException iae) {
      LOG.info("The corrupt filepath "+ fullPathStr + " is visited");
